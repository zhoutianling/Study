...
class ShimmerLayout @JvmOverloads constructor(context: Context, attributes: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attributes, defStyleAttr) {
    ...
    private val radius = 25f.dp
    private val radii = floatArrayOf(radius, radius, radius, radius, radius, radius, radius, radius)
...
class ShimmerDrawable : Drawable() {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val animateValue = if (valueAnimator != null) valueAnimator!!.animatedValue as Float else 0f
    ...
    private fun updateShader() {
        ...
        val shader = LinearGradient(0f, 0f, boundsW.toFloat(), 0f, Shimmer.colors, Shimmer.position, Shader.TileMode.CLAMP)
