...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_hl_shadowColor, getResources().getColor(R.color.baseThemeColor));
            mBackGroundColor = attr.getColor(R.styleable.ShadowLayout_hl_shadowBackColor, getResources().getColor(R.color.baseThemeColor));
            mBackGroundColorClicked = attr.getColor(R.styleable.ShadowLayout_hl_shadowBackColorClicked, getResources().getColor(R.color.baseThemeColor));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCornerRadius > (float) trueHeight / 2) {
            //画圆角矩形
            canvas.drawRoundRect(rectf, (float) trueHeight / 2, (float) trueHeight / 2, paint);
